<template>
  <div id="fullLoading" v-if="isShow" :tip="tip">
    <!-- <van-loading type="spinner" class="fe_loading"/> -->
    <span class="loading_box">
...
.loading_box {
  ...
  .loading_circle {
    ...
    width: 100%;
    height: 100%;
    animation: jm-rotate 1.6s linear 0s infinite;
