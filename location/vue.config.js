...
module.exports = {
  baseUrl: '/activity/2018/location/html/', // 网页访问的基础目录如etc.jd.com/ 就应该用默认的'/'
  outputDir: 'html', // 打包后的输出目录
  assetsDir: 'static', // 静态资源目录 默认为空即直接将assets里的目录结构放在dist下 我现在修改为static
  pages: {
    page1: {
      entry: 'src/pages/liehudaojia/main.js',
      template: 'public/liehudaojia.html',
      filename: 'liehudaojia.html'
    },
    page2: {
      entry: 'src/pages/coupon/main.js',
